...
const About = ({ setCurrentTab, t, profileData }: AboutType) => {
    ...
    const personalInfo: PersonalInfoType = [
        ...
        { icon: join, title: t("profile.joined"), description: profileData.created_at },
    ...
    const socialNetworks = [
        {icon: facebook, link: profileData.contacts.facebook},
        {icon: youtube, link: profileData.contacts.youtube},
        {icon: vk, link: profileData.contacts.vk},
        {icon: instagram, link: profileData.contacts.instagram},
        {icon: linkedin, link: profileData.contacts.linkedin},
        {icon: twitter, link: profileData.contacts.twitter},
        {icon: telegram, link: profileData.contacts.telegram},
    ]
    ...
    const socialNetworksItems = socialNetworks.map((e, i) => <a href={e.link} key={i} target="blank"><div className={s.social_link}><img src={e.icon} alt="socialicon" width={20}/></div></a> )
